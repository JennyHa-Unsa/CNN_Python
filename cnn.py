...
archivo_train_path = 'database/SimpsonsMNIST/simpsom_train.csv'
archivo_test_path = 'database/SimpsonsMNIST/simpsom_test.csv'
...
# Reshape de las imágenes a formato 28x28x1 para que TensorFlow las entienda
...
# División de los datos de entrenamiento en un conjunto de validación
...
model.save('simpson_cnn_model.h5')
